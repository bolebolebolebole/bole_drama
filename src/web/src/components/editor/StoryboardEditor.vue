      ...
      <div class="preview-area">
        <div class="preview-container">
          ...
          <div v-if="currentShot?.video_url" class="preview-video">
            <video :src="getVideoProxyUrl(currentShot.video_url)" controls style="max-width: 100%; max-height: 100%;" />
          </div>
          <!-- 背景图预览 -->
          ...
          <div class="param-section" v-if="currentShot">
            <div class="param-group">
              ...
              <div class="video-preview" v-if="currentShot.video_url" @click="toggleVideoPlay">
                <video ref="videoPlayerRef" :src="getVideoProxyUrl(currentShot.video_url)" style="width: 100%;" @ended="videoPlaying = false" />
...
const handleGenerateVideo = async () => {
  ...
  try {
    ...
    if (!props.dramaId) {
      ElMessage.warning('缺少 dramaId，无法生成视频')
      return
    }
